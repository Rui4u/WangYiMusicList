...
- (void)longPressGestureRecognized:(id)sender {
    ...
    switch (state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            if (indexPath && ![indexPath isEqual:sourceIndexPath] &&sourceIndexPath != nil) {
                
                // ... update data source.
                [_tempArray exchangeObjectAtIndex:indexPath.row withObjectAtIndex:sourceIndexPath.row];
